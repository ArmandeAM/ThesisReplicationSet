...
# Sensitivity check : 3 factors for Healthcare Perceptions: better fit in the CFA but no variable load in the third factor. 
...
# Suppose we decide on k = 3 based on the above analyses:
set.seed(123)
...
# 3. Residuals vs. Fitted Plot for the Mixed Model
plot(fitted(model_lmm), resid(model_lmm),
     xlab = "Fitted Values", ylab = "Residuals",
     main = "Residuals vs. Fitted Values")
abline(h = 0, col = "red")

# 4. Residuals vs. Predictor Plots in a 2x4 grid
...
alpha <- model_clmm$alpha           # vector of thresholds; alpha[2] is the cutpoint for "Perceive inequality"
betas <- summary(model_clmm)$beta   # named vector of slopes

# baseline P(Y="Perceive inequality") when all predictors = 0
P0 <- 1 - plogis(alpha[2])

# for each predictor, shift the linear predictor by beta and recompute P
